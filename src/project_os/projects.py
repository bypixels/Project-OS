...
def load(data):
    ...
    for p in data.get("projects", []):
        ...
        out.append({
            ...
            "worktrees_mb_measured": g.get("worktree_mb_measured", False),
            "worktrees_detail": [{"name": w["name"], "mb": w["mb"], "mtime": w["mtime"], "dirty": w["dirty"],
                                  "branch": w.get("branch", ""), "prunable": w.get("prunable", False)} for w in wt],
